...
(function () {
  ...
  function resolveAndComposeImportMap (json, baseUrl, outMap) {
    console.log('resolveAndComposeImportMap', json, baseUrl, outMap);
    if (json.imports) {
  ...
  systemJSPrototype.import = function (id, parentUrl, meta) {
      console.log('System.import', id, parentUrl, meta);
      var loader = this;
  ...
  systemJSPrototype.prepareImport = function (doProcessScripts) {
      console.log('systemJSPrototype.prepareImport');
    ...
    [].forEach.call(document.querySelectorAll('script'), function (script) {
      ...
      if (script.type === 'systemjs-module') {
        ...
        if (!script.src)
          ...
          console.log('systemjs-importmap src: ', script.src);
  ...
  systemJSPrototype.instantiate = function (url, firstParentUrl) {
    console.log('systemJSPrototype.instantiate', url, firstParentUrl);
  ...
  systemJSPrototype.set = function (id, module) {
    console.log('systemJSPrototype.set', id, module);
    {
      try {
